                ...
                <c:forEach items="${searchResults}" var="product">
                    <li class="span3">
                        <div class="product-box">
                            <!-- 상품 이미지 -->
                            <p><a href="product_detail.html"><img src="${product.photo}" alt="${product.name}"/></a></p>
                            <!-- 상품명 -->
                            <a href="product_detail.html" class="title product-name">${product.name}</a><br />
                            <!-- 현재 입찰가 -->
                            <a href="products.html" class="category">현재 입찰가: </a>
                            <p class="price">${product.currentBid}&nbsp;<i class="fa-solid fa-won-sign"></i></p>
                            <!-- 입찰자 수 -->
                            입찰자: ${product.bidCount}
                            <p class="BidCount">
                                <i class="fa-solid fa-heart heart-icon" onclick="toggleHeart(this)" data-product-id="${product.productID}"></i>
                            </p>
                        </div>
                    </li>
                </c:forEach>
