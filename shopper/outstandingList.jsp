...
<li id="profileDeleteLi"><a href="./profileDelete.jsp">회원탈퇴신청</a></li>
    ...
    <script>
        ...
        $(document).ready(function() {
            // 임시 데이터
            var bidData = [
            	 { number: 1, id: "104 (abcd1234)", product: "버버리 스닙 백", currentBid: "결제 미완료", myBid: "5,400,000원" },
                 { number: 2, id: "105 (efgh5678)", product: "버버리 브로드리 앙글레즈 캔버스 팬츠", currentBid: "결제 미완료", myBid: "5,000,000원" }
            ];
